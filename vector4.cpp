...
void luaReg_vector4(lua_State* L, lua_Option opt) {
	if (opt["api"]["geometry"]["vector4"]) {
		tm_debuglog_apiloaded(opt, "vector4");
		...
		tm_debuglog_apinoloaded(opt, "vector4");
	}
}